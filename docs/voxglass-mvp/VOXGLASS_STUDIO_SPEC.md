...
jobs:
  ...
  core-tests:  # macos-latest — swift test --skip VoxglassPerformanceTests (parallel) + swift test --no-parallel --filter VoxglassPerformanceTests (serial timing); no simulator
